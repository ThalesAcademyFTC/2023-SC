...
@Autonomous(name="Auton Blue Left Top Corner")
public class TopLeftBlue extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (Johnny5.ftcColor.WHITE == detected) {
            ...
            if (detected2 == Johnny5.ftcColor.WHITE) {
                ...
                robot.move(Johnny5.Direction.LEFT, 2, .4);
                sleep(200);
                robot.dropPixel1();
                sleep(200);
                robot.move(Johnny5.Direction.LEFT, 28, .4);
            } else {
                //code for 3rd spike mark
                robot.move(Johnny5.Direction.RIGHT, 22, .5);
                sleep(200);
                robot.dropPixel1();
                sleep(200);
                robot.move(Johnny5.Direction.BACKWARD,2,.5);
                sleep(200);
                robot.move(Johnny5.Direction.LEFT, 50, .5);
                sleep(200);
                robot.dropPixel2();
                sleep(200);
                robot.move(Johnny5.Direction.BACKWARD, 2, .5);
