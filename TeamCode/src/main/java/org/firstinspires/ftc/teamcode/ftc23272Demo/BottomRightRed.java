...
@Autonomous(name="Auton Red Right Bottom Corner")
public class BottomRightRed extends LinearOpMode {
        ...
        sleep(500);
         if (Johnny5.ftcColor.WHITE == detected) {
            ...
            robot.move(Johnny5.Direction.RIGHT, 88, .4);
             ...
             robot.move(Johnny5.Direction.FORWARD, 5, .4);
             sleep(200);
             robot.move(Johnny5.Direction.LEFT, 17, .4);
             sleep(200);
             robot.move(Johnny5.Direction.BACKWARD, 15, .4);
             sleep(200);
